        ...
        <div class="px-8 pt-8 pb-4 flex-1 overflow-y-auto">
            <div class="bg-gradient-to-r from-orange-500 to-blue-600 rounded-3xl p-8 text-white relative overflow-hidden mb-8">
                ...
                <div class="relative z-10 flex items-center justify-between">
                    <div>
                        <h1 class="text-4xl font-bold mb-2">Service Jobs</h1>
                        <p class="text-orange-100">View and manage your assigned service jobs</p>
                    </div>
                                ...
                                <tr class="border-b border-slate-50 last:border-none hover:bg-slate-50/50 transition-colors group">
                                    <td class="py-4 px-6">
                                        <a href="{{ route('employee.jobs.show', $job) }}" class="flex items-center gap-3 group/link">
                                            ...
                                            <div>
                                                <div class="font-semibold text-slate-900 group-hover/link:text-orange-600 transition-colors">{{ $job->name }}</div>
