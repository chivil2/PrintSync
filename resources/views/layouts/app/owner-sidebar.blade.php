...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-zinc-50 dark:bg-zinc-900">
        ...
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950">
            ...
            <flux:sidebar.nav>
                <flux:sidebar.item href="{{ route('profile.edit') }}" wire:navigate>
                    <x-slot:icon>
            ...
            <div class="border-t border-zinc-200 dark:border-zinc-800 px-4 pt-4 pb-4 mt-2">
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <div class="min-w-0 flex-1">
                        <div class="text-sm font-medium text-zinc-900 dark:text-white truncate">{{ auth()->user()->name }}</div>
                        <x-role-badge :role="auth()->user()->getRoleNames()->first()" />
                    </div>
                </div>
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <flux:button as="button" type="submit" variant="outline" size="sm" class="w-full! cursor-pointer">
                        Log out
                    </flux:button>
                </form>
            </div>
