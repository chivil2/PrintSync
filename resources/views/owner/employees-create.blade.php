            ...
            <form action="{{ route('owner.employees.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div class="rounded-xl border border-zinc-200 bg-white shadow-sm p-6 space-y-5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="first_name" name="first_name" value="{{ old('first_name') }}" required
                                    class="w-full rounded-lg border border-zinc-300 px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">
                        ...
                        <div>
                            <label for="phone" class="block text-sm font-medium text-zinc-700 mb-1">Phone</label>
                        ...
                        <div>
                            <label for="password" class="block text-sm font-medium text-zinc-700 mb-1">Password <span class="text-red-500">*</span></label>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" id="hourly_rate" name="hourly_rate" value="{{ old('hourly_rate') }}" step="0.01" min="0"
                                        class="w-full rounded-lg border border-zinc-300 pl-7 pr-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">
                                </div>
