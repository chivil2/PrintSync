                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select id="specialization" name="specialization"
                                    ...
                                    <option value="printing_staff" {{ old('specialization') === 'printing_staff' ? 'selected' : '' }}>Printing Staff</option>
                                    <option value="technical_staff" {{ old('specialization') === 'technical_staff' ? 'selected' : '' }}>Technical Staff</option>
                                </select>
