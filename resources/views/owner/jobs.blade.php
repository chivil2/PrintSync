                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="border-b border-zinc-200 bg-zinc-50 text-left">
                            ...
                            <th class="px-6 py-3 font-medium text-zinc-600">Started At</th>
                            <th class="px-6 py-3 font-medium text-zinc-600">Ended At</th>
                            ...
                            <div class="p-4 hover:bg-zinc-50 transition-colors {{ $loop->even ? 'bg-zinc-50' : '' }}">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-xs text-zinc-500 truncate">{{ $employee->specializationLabel() }}</p>
                                    </div>
                                </div>
                            </div>
                        @endforeach
