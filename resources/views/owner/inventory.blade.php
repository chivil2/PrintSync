                            ...
                            <tr :class="index % 2 === 0 ? 'bg-white' : 'bg-slate-50'" class="hover:bg-emerald-50 transition-colors">
                                ...
                                <td class="border border-slate-300 px-3 py-2 text-center">
                                    <div class="flex items-center justify-center gap-1">
                                        <a :href="'/owner/inventory/' + item.id + '/edit'" class="p-1.5 text-blue-600 hover:bg-blue-50 rounded transition-colors" title="Edit">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                            </svg>
                                        </a>
                                        <button @click="deleteUrl = '/owner/inventory/' + item.id; showDeleteModal = true" class="p-1.5 text-red-600 hover:bg-red-50 rounded transition-colors" title="Delete">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
