<x-layouts::app.owner>
    <div class="p-4 sm:p-6 lg:p-8 max-w-[1600px] mx-auto">
        ...
        <div class="bg-blue-600 rounded-lg px-6 py-4 mb-6">
            ...
            <p class="text-blue-100 text-sm">Add a new service to your catalog</p>
        </div>

        <!-- Form -->
        <div class="bg-white rounded-lg shadow-sm border border-slate-300 p-6" x-data="{ 
            previewImage: null,
            showRemove: false,
            isLoading: false,
            ...
            <form x-ref="form" action="{{ route('owner.services.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6" @submit.prevent="handleSubmit">
                @csrf
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div class="relative">
                            <div class="relative inline-block">
                                <img :src="previewImage || ''" alt="Preview" class="w-32 h-32 object-cover rounded-lg border border-slate-300 bg-slate-100">
                                <div x-show="!previewImage" class="absolute inset-0 flex items-center justify-center text-slate-400 text-xs">
                                    No image
                                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Service Type -->
                    <div>
                        <label for="service_type" class="block text-sm font-medium text-slate-700 mb-2">Service Type <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        ...
                        <input type="number" id="production_time" name="production_time" value="{{ old('production_time', 7) }}" min="1"
                            class="w-full px-4 py-2 text-sm border border-slate-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            placeholder="7">
                ...
                <div class="flex items-center gap-4 pt-4 border-t border-slate-200">
                    <button type="submit" :disabled="isLoading"
                        ...
                        <span x-text="isLoading ? 'Creating...' : 'Create Service'"></span>
                    </button>
