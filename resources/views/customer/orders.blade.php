                        ...
                        <div class="flex items-start justify-between">
                            ...
                            <div class="ml-6 flex flex-col items-center gap-3">
                                ...
                                @if($order->invoice_path && $order->status === 'completed')
                                    <a href="{{ route('customer.orders.invoice', $order) }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-green-600 bg-green-50 rounded-lg hover:bg-green-100 transition-colors" onclick="event.stopPropagation()">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
