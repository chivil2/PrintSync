            ...
            <div class="flex-1 p-6 md:p-7 flex flex-col gap-4">
                ...
                <div class="p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                    <div class="flex items-start gap-2.5">
                        ...
                        <div>
                            <p class="text-xs font-semibold text-yellow-900">Estimated Completion</p>
                            <p class="text-sm text-yellow-700 mt-0.5" x-text="estimatedCompletion ? 'Ready by ' + estimatedCompletion : 'Select a service to see estimate'"></p>
                        </div>
                    </div>
                </div>
            </div>
